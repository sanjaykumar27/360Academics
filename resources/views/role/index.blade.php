...
@section('content')
<div class="d-wrapper d-master" ng-controller="roleController" ng-cloak >
       ...
       <div class="container">
         <md-toolbar class="d-listing_toolbar">
            <div class="d-searchbar" ng-show="showme"> 
              <button ng-click="showme=false" class="md-fab md-mini md-button md-ink-ripple" aria-label="Search Role">
            ...
            <div class="d-toolbar_icon pull-right">
              <button ng-click="showme=true"  class="md-fab md-mini md-button md-ink-ripple" aria-label="Search Role">
		   ...
		   <div class="modal-body clearfix">
			  <div class="panel panel-default">
				<div class="panel-heading clearfix">
				  <h3 class="panel-title d-no_padding">@{{role_form}} Role</h3> 
				</div> 
			  </div>
			  <div class="clearfix well">
			  <form   method="post" name="frmrole" id="frmrole" ng-submit="saverecord(frmrole.$valid)"  novalidate="novalidate" >
			  <input type="hidden" name="_token"  value="{{csrf_token()}}" ng-model="singledata._token">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
					<md-input-container class="md-block" ng-class="(submitted && !frmrole.role_name.$valid) ? 'd-validation-error' : ''" flex-gt-sm> 
					  <label>Role Name</label>
					  <input type="text" ng-model="singledata.role_name" name="role_name" required ng-minlength="3" ng-model-options="{debounce : 700}">
					  <div ng-show="submitted && frmrole.role_name.$error " class="md-input-messages-animation md-auto-hide ng-active">
						 <div ng-show="frmrole.role_name.$error.required">{{ config('constant.error.Required') }}</div>
						 <div ng-show="frmrole.role_name.$error.minlength">{{ config('constant.error.RoleNameMinLength') }}</div>
					  </div>
					</md-input-container>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
