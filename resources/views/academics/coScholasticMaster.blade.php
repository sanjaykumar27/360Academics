                            ...
                            <div class='table-responsive'>
                                <table class='table table-bordered'>
                                    <table class="table table-striped table-hover table-bordered">
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td ng-click="showList2 = !showList2">English II
                                        ...
                                        <tr ng-show="showList2">
                                            <td align="right">i.</td>
                                            <td colspan="3">Learning</td>
                                        </tr>
                                        <tr ng-show="showList2">
                                            <td align="right">ii.</td>
                                            <td colspan="3">Reading Ability</td>
                                        </tr>
                                    </table>
                                </table>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Create Subject Criteria</div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <md-input-container class="md-block">
                                        <label>Select Academic Criteria</label>&nbsp;
                                        <select ui-select2 ng-model="singledata.academics"   required >
                                            <option ng-value="class.id">Scholastic</option>
                                            <option ng-value="class.id">Co Scholastic</option>
                                        </select>
                                    </md-input-container>
                                </div>
                            </div>
                            <p class='label label-primary'>If scholastc is selected</p><br>
                            <div class="row" ng-repeat="data in ctrl.add">
                                <div class="col-lg-4">
                                    <md-input-container class="md-block">
                                        <label>Select Subject</label>
                                        <select ui-select2 ng-model="singledata.academics" placeholder="Select Subjects"  required>
                                            <option ng-value="class.id">English</option>
                                            <option ng-value="class.id">Hindi</option>
                                            <option ng-value="class.id">Maths</option>
                            ...
                            <p class='label label-info'>If Co scholastc is selected</p>
                            <div class="row" ng-repeat="data in ctrl.add">
                                <div class="col-lg-4">
                                    <md-input-container class="md-block">
