...
<div class='container-d'>
    <div class='container-fluid'>
        <div class='panel panel-primary'>
            <div class='panel-heading'>Input Marks of Students</div>
            ...
            <div class='row md-padding'>
                <div class='col-lg-12'>
                    <div class='table-responsive'>
                        <table class='table table-bordered md-caption' style="overflow-x: scroll; display: block; text-align: center">
                            <tr>
