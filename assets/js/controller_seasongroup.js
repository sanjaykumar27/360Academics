...
app.controller('classteacherallocation', function ($scope) {

});



app.controller('timetablemaster', function ($scope, $http, $compile, $window) {
    ...
    this.repeatData = $scope.periodrow.map(function (value, index) {
        return {
            ...
            endtime: $scope.endtimerwow[index]
        }
    });

    $scope.addRow = function () {
        $scope.periodrow.push("Period " + $scope.counter);
        $scope.starttimerow.push('9:00 AM');
        $scope.endtimerwow.push('9:45 AM ');
        this.repeatData = $scope.periodrow.map(function (value, index) {
            return {
                period: value,
                starttime: $scope.starttimerow[index],
